// Resuelve el código ATP de un jugador a partir de su slug de TennisExplorer.
// Usa un mapa estático de los top-500 ATP (actualizado 2026-03-31) como
// fuente principal; así evitamos depender de fetch server-side a atptour.com
// que devuelve HTML diferente al del navegador (TLS fingerprinting).

// Mapa "última-parte-del-slug-ATP" → código ATP
// Ejemplo: "dino-prizmic" → clave "prizmic" → valor "p0hw"
const LAST: Record<string, string> = {
  ...
  "ramos-vinolas":"r772", hernandez:"h0cd", "alex-martinez":"m0gb",
  ...
  "lopez-montagud":"l0c1", "sanchez-jover":"s0cg", stebe:"sk94",
  cretu:"c0b2", langmo:"li10", negritu:"n731", eubanks:"e865",
  denolly:"df92", vandermeersch:"v0bc", "dali-blanch":"b0jp",
  "dutra-da-silva":"sg56", masur:"mn20", michalski:"m0e1",
  milavsky:"m0rg", rincon:"r0fp", "darwin-blanch":"b0no",
  "jorda-sanchis":"j476", yevseyev:"y171", suresh:"s0de",
  dedura:"d0lj", kuzmanov:"kc33", popko:"pg20", stricker:"s0la",
  ajdukovic:"a0cj", obradovic:"o0ai", butvilas:"b0mm",
  ribeiro:"r09v", winter:"w0c4", vasa:"v993", coulibaly:"c0hb",
  "dalla-valle":"dg80", arutiunian:"a0ia", andaloro:"a0f3",
  bagnis:"bf23", mena:"mj98", sun:"sx90", zakaria:"z0bl",
  arnaboldi:"a0ba", bondioli:"b0pe", "meligeni-alves":"mw75",
  peliwo:"pf65", moroni:"m0gp", romano:"r0hk", bax:"b0bu",
  broska:"b0c5", agamenone:"aa27", roncadelli:"r0bt",
  piraino:"p0i6", johns:"j0b5", elias:"e698",
  ...
  marcondes:"rd48", "montes-de-la-torre":"m0nl", xilas:"x01c",
  gakhov:"ge28", loge:"l0id", "jacopo-berrettini":"bu10",
  story:"s0h9", trotter:"t0bw", "barranco-cosano":"bv25",
  friend:"h0jl", sels:"so20", cui:"c0aj", schiessl:"s0t1",
  monday:"m0on", forejtek:"f0bt", "bautista-torres":"t0dm",
  estevez:"e0di", "la-serna":"l0gr", varillas:"v836",
  shang:"s0re", boulais:"b0f8", singh:"s0ri", samrej:"s0hr",
  "keegan-smith":"s0dq", nishikori:"n552", feldbausch:"f0f4",
  lokoli:"lc12", tu:"tc01", broady:"bi23", marmousez:"m0gy",
  carboni:"c0ow", "lorenzo-rodriguez":"r0bc", castelnuovo:"ch80",
  potenza:"p0b2", poullain:"pj74", ambrogi:"a0ik", ratti:"r0hp",
  maxted:"m0nj", pokorny:"p0hp", kasnikowski:"k0hc",
  dhamne:"d0ji", sharipov:"s0mn", polmans:"pg94", gengel:"g09c",
  topo:"t0fi", krumich:"k0fy", "marvin-moeller":"m0bn",
  imamura:"i426", "pucinelli-de-almeida":"p0df", erhard:"e0ac",
  soto:"s0ek", rosenkranz:"rh62", martineau:"mw76",
  dellavedova:"d0a2", "alcala-gurri":"a0ea", basing:"b0je",
  wiskandt:"w0bb", mrva:"m0se", zhukov:"z0c3", jones:"j0d2",
  rottgering:"r0kd", alkaya:"a09q", geerts:"gg65", mmoh:"mp01",
  ribecai:"r0jw", damas:"d0cn", brunold:"b0lw",
  kukushkin:"k926", poljicak:"p0gq", karol:"k0hg",
  "mitchell-krueger":"kc12", bouzige:"b0ek", kouame:"k0o4",
  "murkel-dellien":"dc48", oberleitner:"o0ad",
  "alvarez-varona":"a09u", kicker:"kc29",
  "sanchez-izquierdo":"s0gz", gombos:"gb93", milic:"m0ur",
  pieczkowski:"p0it", prihodko:"pl64", tarvet:"t0gr",
  wallin:"w0bu", jasika:"j553", "roca-batalla":"rb60",
  maloney:"m0re", zahraj:"z09f", jubb:"j0a4", kotov:"k09f",
  "pedro-sakamoto":"sl94", "bar-biryukov":"b0lq",
  brunclik:"b0ov", nesterov:"n0cj", henning:"h0bf",
  sekulic:"s0ti", fellin:"f0bp", "martin-tiffon":"m0ea",
  vandecasteele:"v0dg", albot:"a829", perot:"p0mg",
  brancaccio:"bv24", tokuda:"td55", gasquet:"g628",
  strombachs:"s0gv", "cid-subervi":"cf88", bertrand:"b0jj",
  catry:"c0jt", "pacheco-mendez":"p0j1", molleker:"m0ac",
  nijboer:"n0b4", peniston:"ph78", purtseladze:"p0ea",
  banerjee:"b0i6", pieri:"p0hy", kopp:"k0cj", shin:"s09p",
  "gueymard-wayenburg":"g0gw", cuenin:"c0jx", sorger:"s0qz",
  fomin:"f0a3", kwon:"kf17", dostanic:"d0d4", kozlov:"ke64",
  palosi:"p0cy", napolitano:"n679", nagal:"n897",
  daniel:"da81", monteiro:"mj08", faurel:"f0ho",
  "tiago-pereira":"p0k4", paris:"p0gn", berkieta:"b0p4",
  compagnucci:"c0bb", "trevor-svajda":"s0vm", huang:"h0b5",
  "tung-lin-wu":"w857", zink:"z0ak", ursu:"u176",
  bielinskyi:"b0ll", durasovic:"dc76", erel:"e0aa",
  uchiyama:"u134", shimizu:"s0aq", zhang:"z371",
};

// Caché slug TE → código ATP (solo entradas positivas)
...
function resolveAtpCode(teSlug: string): string | null {
  ...
  // 3. Primera parte (apellido compuesto como "merida" de "merida-aguilar")
  if (!code && parts.length > 1) code = LAST[parts[0]];

  // 4. Slug parcial progresivo (por si tiene más partes)
  if (!code && parts.length > 2) {
    for (let i = 1; i < parts.length; i++) {
      code = LAST[parts.slice(i).join("-")] ?? LAST[parts[i]];
      if (code) break;
    }
  }

  if (code) slugCache.set(teSlug, code);
  return code ?? null;
}

export async function GET(
  _req: Request,
  ctx: RouteContext<"/api/player-photo/[slug]">
) {
  ...
  const atpCode = resolveAtpCode(slug);
  if (!atpCode) {
    return Response.json({ photo: null }, { status: 404 });
  }

  const photo = `https://www.atptour.com/-/media/alias/player-headshot/${atpCode}`;
  return Response.json({ photo, atpCode }, {
